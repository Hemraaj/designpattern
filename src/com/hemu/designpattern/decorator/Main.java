...
public class Main {
	public static void main(String[] args) {
		...
		// we can also do this nesting of functionality in separate statements.
		System.out.println("creating object with similar functionality in separate statements.");
		Circle c = new Circle();
